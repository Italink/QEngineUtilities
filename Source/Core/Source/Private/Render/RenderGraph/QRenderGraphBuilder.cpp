...
QRhi* QRenderGraphBuilder::rhi() const
{
	return mRhi;
}

const QShader& QRenderGraphBuilder::fullScreenVS()
{
	return mFullScreenVertexShader;
}

IRenderer* QRenderGraphBuilder::renderer() const
{
	return mRenderer;
}
...
QRhiRenderTarget* QRenderGraphBuilder::mainRenderTarget() const
{
