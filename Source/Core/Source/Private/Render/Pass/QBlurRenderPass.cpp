...
//	);
//
//	QShader fsDownSample = QRhiHelper::newShaderFromCode( QShader::FragmentStage, R"(#version 450
...
//	QShader fsH = QRhiHelper::newShaderFromCode( QShader::FragmentStage, R"(#version 450
//		layout (location = 0) in vec2 vUV;
//		layout (location = 0) out vec4 outFragColor;
//		layout (binding = 0) uniform sampler2D uTexture;
//
...
//	QShader fsV = QRhiHelper::newShaderFromCode( QShader::FragmentStage, R"(#version 450
//	layout (location = 0) in vec2 vUV;
//	layout (location = 0) out vec4 outFragColor;
//	layout (binding = 0) uniform sampler2D uTexture;
//
