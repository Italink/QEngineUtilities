...
//	QShader skyboxVs = QRhiHelper::newShaderFromCode( QShader::VertexStage, R"(#version 450
...
//		}
//	)");
//	QShader skyboxFs = QRhiHelper::newShaderFromCode( QShader::FragmentStage, R"(#version 450
