...
class QENGINEEDITOR_API ColorPalette : public QObject
{
	Q_OBJECT
		 ...
		 */
		Q_PROPERTY(QVector<value_type> colors READ colors WRITE setColors NOTIFY OnColorsChanged)
		/**
...
public:
	 ...
	 */
	QPixmap mColorPreview(const QSize& size, const QColor& background = Qt::transparent) const;
...
Q_SIGNALS:
	 ...
	 */
	void OnColorsChanged(const QVector<QPair<QColor, QString> >&);
