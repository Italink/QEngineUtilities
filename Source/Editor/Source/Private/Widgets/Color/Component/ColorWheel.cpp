...
ColorWheel::ShapeEnum ColorWheel::selectorShape() const
{
	return p->selector_shape;
}

void ColorWheel::setColorSpace(ColorWheel::ColorSpaceEnum space)
{
...
void ColorWheel::setSelectorShape(ColorWheel::ShapeEnum shape)
{
